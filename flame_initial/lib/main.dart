...
class OrientationFrame extends StatelessWidget {
  ...
  OrientationFrame({super.key, required this.title});
...
class BluetoothWidget extends StatefulWidget {
  ...
  const BluetoothWidget(this.ble );
  State<StatefulWidget> createState() => BleuetoothState(ble);
}

class BleuetoothState extends State<BluetoothWidget> {
  FlutterReactiveBle ble;
  BleuetoothState(this.ble);
  @override
  Widget build(BuildContext context) {
    return TestCard(myContent:ble.status.toString());
  }
}

class BLEfunctions{
  FlutterReactiveBle ble;
  BLEfunctions(this.ble);
...
class _steeringState extends State<steeringWidget> {
  ...
  Image steeringWheel = Image.asset(
    'assets/steering-wheel-icon.png',
    fit: BoxFit.fitWidth,
    color: Colors.white70,
  );
  Image steeringArrows = Image.asset(
    'assets/steeringArrowsPos_2.png',
    fit: BoxFit.fitWidth,
    color: Colors.white70,
  );
  ...
  Widget build(BuildContext context) {
   // _height = MediaQuery.of(context).size.height;
    _width = _key.currentContext != null
        ? (_key.currentContext!.findRenderObject() as RenderBox).size.width
            ...
            children: [
              ...
              GestureDetector(
                onHorizontalDragUpdate: (details) {
                  setState(() {
                    morning_angle =
                        calc().steeringAngle(_width, details.localPosition.dx);
                    print("position" +
...
class _gasBreakState extends State<gasBreakWidget> {
  ...
  Image acceleratorImage = Image.asset(
    ...
    return Padding(
      ...
      child: GestureDetector(
        onVerticalDragUpdate: (details) {
          ...
          setState(() {
            _position = calc().gasPosition(
                _height, details.localPosition.dy); //details.localPosition.dy;
          ...
          child:
            ...
            CustomPaint(
              painter: progressPainter(
                  _position, Theme.of(context).colorScheme.secondaryContainer),
              size: Size.fromWidth(
